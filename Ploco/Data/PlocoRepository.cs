    ...
    public class PlocoRepository
    {
        ...
        public void Initialize()
        {
            ...
            var commands = new[]
            {
                ...
                @"CREATE TABLE IF NOT EXISTS rolling_lines (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
                    tile_id INTEGER NOT NULL,
                    line_number INTEGER NOT NULL,
                    position INTEGER NOT NULL,
                    UNIQUE(tile_id, line_number),
                    FOREIGN KEY(tile_id) REFERENCES tiles(id)
                );",
                @"CREATE TABLE IF NOT EXISTS rolling_line_locomotives (
                    line_id INTEGER PRIMARY KEY,
                    loco_id INTEGER NOT NULL,
                    FOREIGN KEY(line_id) REFERENCES rolling_lines(id),
        ...
        public void SaveState(AppState state)
        {
            ...
            ExecuteNonQuery(connection, "DELETE FROM rolling_line_locomotives;");
            ExecuteNonQuery(connection, "DELETE FROM tracks;");
            ExecuteNonQuery(connection, "DELETE FROM rolling_lines;");
